$("#curs").click(function(){
    ...
    str += 'Anh biết anh không giỏi nói ngọt ngào\n';
    str += 'Nhưng anh sẽ chứng minh nó bằng\n';
    str += 'những điều tuyệt vời nhất của anh dành cho em\n';
    str += 'Nếu anh là nhà thơ anh sẽ viết tặng em những vần thơ cháy bỏng\n';
    str += 'Nếu anh là nhạc sỹ anh sẽ viết tặng em những bản tình ca bất hủ\n';
    str += 'Nếu anh là coder anh sẽ viết nên những đoạn mã ngập tràn hương vị tình yêu\n';
    str += 'Và nếu anh có thể anh sẽ làm tất cả vì em\n';
    str += 'Vì\n';
    str += 'Anh\n';
    str += 'yêu\n';
    str += 'em\n';
...
function SetTime(){
    ...
    var date1 = new Date("Mar 14 2021 20:00:00 GMT+0700")
    var date2=new Date(); 
    console.log(date2);
...
window.onload = function(){
    ...
    for ( var i=0;i<oImgLength;i++) {
        oImg[i].style.transform = 'rotateY('+ i*Deg +'deg) translateZ(400px)';
